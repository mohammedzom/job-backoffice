        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="px-8 py-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Update the company information.') }}</p>
                </div>
                <div class="p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    value="{{ old('name', $company->name) }}" placeholder="{{ __('e.g. Acme Corporation') }}">
                                @error('name')
                            ...
                            <div>
                                ...
                                <input type="text" name="industry" id="industry"
                                    ...
                                    value="{{ old('industry', $company->industry) }}" placeholder="{{ __('e.g. Technology, Healthcare') }}">
                                @error('industry')
                                    <p class="mt-2 text-sm text-red-500 dark:text-red-400 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="url" name="website" id="website"
                                    ...
                                    value="{{ old('website', $company->website) }}" placeholder="{{ __('https://example.com') }}">
                                @error('website')
                                    <p class="mt-2 text-sm text-red-500 dark:text-red-400 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="address" id="address"
                                    ...
                                    value="{{ old('address', $company->address) }}" placeholder="{{ __('123 Business Rd, City, Country') }}">
                                @error('address')
                                    <p class="mt-2 text-sm text-red-500 dark:text-red-400 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
