<x-app-layout>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-8">
                    <form action="{{ route('job-vacancy.store') }}" method="POST">
                                ...
                                @else
                                    <div x-data="{
                                                ...
                                                render: {
                                                    option: function(data, escape) {
                                                        return '<div class=\'flex items-center gap-2 py-0.5\'>' +
                                                            '<span class=\'inline-flex items-center justify-center w-6 h-6 rounded bg-indigo-100 text-indigo-600 text-xs font-bold\'>' + escape(data.text.charAt(0).toUpperCase()) + '</span>' +
                                                            '<span>' + escape(data.text) + '</span></div>';
                                                    },
                                                    item: function(data, escape) {
                                                        return '<div class=\'flex items-center gap-1\'>' +
                                                            '<span class=\'inline-flex items-center justify-center w-5 h-5 rounded bg-indigo-100 text-indigo-600 text-xs font-bold\'>' + escape(data.text.charAt(0).toUpperCase()) + '</span>' +
                                        ...
                                        <select x-ref="companySelect" name="company_id" id="company_id"
                                            ...
                                            <option value="" disabled {{ old('company_id') ? '' : 'selected' }}>{{ __('Select a company') }}</option>
                                ...
                                <div class="relative mt-1">
                                    <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-indigo-400 dark:text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 005.25 9h13.5A2.25 2.25 0 0121 9v7.5M9 14.25h6" />
                                        </svg>
                                    </div>
                        ...
                        <div class="mt-10 flex items-center justify-end gap-3 border-t border-gray-100 dark:border-gray-700 pt-6">
    ...
    <style>
        ...
        .flatpickr-input.flatpickr-mobile { display: block !important; }
    </style>
</x-app-layout>
