        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="px-8 py-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100">{{ __('Edit Category') }}</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Update the name or details of this job category.') }}</p>
                </div>
                <div class="p-8">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    value="{{ old('name', $jobCategory->name) }}" placeholder="{{ __('e.g. Software Engineering') }}">
                                @error('name')
